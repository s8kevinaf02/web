...
//end of IIFE function
	...
	var $testimonials_children_length = $testimonials_owl.find('.owl-stage').children().length;

	for( var i = 0; i < $testimonials_children_length; i++ ) {
		if ( (i + 1) <= 10 ) {
			var text = "<span>" + "0" + (i + 1) + "</span>" + " / " + "0" + $testimonials_children_length;
		} else {
			var text = "<span>" + (i + 1) + "</span>" + " / " + $testimonials_children_length;
		}
		$testimonials_owl.find('.owl-stage').children()[i].querySelector('.count p').innerHTML = text;
	}
